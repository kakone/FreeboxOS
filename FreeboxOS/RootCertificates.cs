...
{
    /// <summary>
    /// Freebox root certificates collection
    /// </summary>
    public class RootCertificates : ReadOnlyCollection<X509Certificate2>, IRootCertificates
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RootCertificates"/> class
        /// </summary>
        public RootCertificates() : base(new List<X509Certificate2>())
        {
            foreach (var certificate in new[] { FreeboxECCRootCA, FreeboxRootCA })
            {
                Items.Add(new X509Certificate2(certificate));
            }
        }
        ...
        private byte[] FreeboxECCRootCA { get; } = Convert.FromBase64String(
        ...
        private byte[] FreeboxRootCA { get; } = Convert.FromBase64String(
